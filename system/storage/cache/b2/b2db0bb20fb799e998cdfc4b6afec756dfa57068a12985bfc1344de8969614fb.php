...
/* mintleaf/template/checkout/login.twig */
class __TwigTemplate_62a8c625292485d41c215970aed023478e9567be721c5fbf72fe37c1d0a0f1fa extends Twig_Template
{
  ...
  <div class=\"col-sm-6\">
    ...
    <div class=\"form-group\">
      ...
      <input type=\"password\" name=\"password\" value=\"\" placeholder=\"";
        // line 35
        echo (isset($context["entry_password"]) ? $context["entry_password"] : null);
        echo "\" id=\"input-password\" class=\"form-control\" /></div>
...
";
    ...
    {
        return "mintleaf/template/checkout/login.twig";
    }
...
/* <div class="row">*/
/*   <div class="col-sm-6">*/
/*     <h5 class="page-heading-1">{{ text_new_customer }}</h5>*/
/*     <p class="font-weight-bold">{{ text_checkout }}</p>*/
/*     <div class="radio">*/
...
/*   </div>*/
/*   <div class="col-sm-6">*/
/*     <h5 class="page-heading-1">{{ text_returning_customer }}</h5>*/
/*     <p class="font-weight-bold">{{ text_i_am_returning_customer }}</p>*/
/*     <div class="form-group">*/
...
/*       <input type="password" name="password" value="" placeholder="{{ entry_password }}" id="input-password" class="form-control" /></div>*/
/*       <div class="form-group"><a href="{{ forgotten }}" class="font-weight-bold">{{ text_forgotten }}</a></div>*/
