...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Agu 2019 pada 10.44
...
(1, 'Default', '', 1, '2019-08-07 14:17:25', '2019-08-07 14:17:25');
...
(1, 1, 'df376eb2085a4751fed281ee22', '::1', '2019-08-07 15:21:40', '2019-08-07 15:21:40');
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2019-08-07 07:34:27'),
(3, 'Euro', 'EUR', '', '€', '2', 0.78460002, 1, '2014-09-25 14:40:00'),
(4, 'Rupiah', 'IDR', 'Rp', '', '', 1.00000000, 1, '2019-08-07 08:23:12');
...
(1, 1, 0, 2, 'yusuf', 'eka', 'yusuf.eka001@gmail.com', '085735641314', '', '23ac660c56534ce675944caa2e149a7a8eaaaae9', 'GsDJmgvU2', NULL, NULL, 0, 0, '', '::1', 1, 0, '', '', '2019-08-07 14:37:39');
...
--
-- Struktur dari tabel `oc_googleshopping_category`
--
...
--
-- Struktur dari tabel `oc_googleshopping_product`
--
...
--
-- Struktur dari tabel `oc_googleshopping_product_status`
--
...
--
-- Struktur dari tabel `oc_googleshopping_product_target`
--
...
--
-- Struktur dari tabel `oc_googleshopping_target`
--
...
(2, 'Indonesia', 'id-id', 'id_ID.UTF-8,id_ID,id-id,id_id,indonesia', '', '', 2, 1);
...
--
-- Dumping data untuk tabel `oc_product_related`
--
...
('0a79aa03aefd45bfa555add3fa', '{\"language\":\"id-id\",\"currency\":\"IDR\",\"user_id\":\"1\",\"user_token\":\"yGCCplKfZ6pkYz6atSLLp8wbjV2QYblI\"}', '2019-08-07 09:05:16'),
('20a2f953c81735e0432e978727', '{\"language\":\"id-id\",\"currency\":\"IDR\"}', '2019-08-07 07:50:33'),
('df376eb2085a4751fed281ee22', '{\"api_id\":\"1\"}', '2019-08-07 08:45:47');
...
(369, 0, 'config', 'config_encryption', '', 0),
...
(330, 0, 'config', 'config_invoice_prefix', 'INV-2019-00', 0),
...
(307, 0, 'config', 'config_language', 'id-id', 0),
(308, 0, 'config', 'config_admin_language', 'id-id', 0),
(309, 0, 'config', 'config_currency', 'IDR', 0),
...
(305, 0, 'config', 'config_country_id', '100', 0),
(306, 0, 'config', 'config_zone_id', '1517', 0),
...
(299, 0, 'config', 'config_email', 'admin@admin.co', 0),
(300, 0, 'config', 'config_telephone', '123456789', 0),
(301, 0, 'config', 'config_fax', '', 0),
(302, 0, 'config', 'config_image', '', 0),
(291, 0, 'config', 'config_meta_description', 'My Store', 0),
(290, 0, 'config', 'config_meta_title', 'Your Store', 0);
...
(1, 1, 'admin', '063f7e2a6899a319cae0555d97f4cc3933db147a', 'z1XYtjagZ', 'admin', 'admin', 'admin@admin.co', '', '', '::1', 1, '2019-08-07 14:17:25');
...
--
-- Indeks untuk tabel `oc_googleshopping_category`
--
...
--
-- Indeks untuk tabel `oc_googleshopping_product`
--
...
--
-- AUTO_INCREMENT untuk tabel `oc_googleshopping_product`
--
ALTER TABLE `oc_googleshopping_product`
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=376;
